...
public class OverpassAPIProvider2 {
    ...
    public static final String OVERPASS_API_SERVICE_MAIN = "https://overpass-api.de/api/interpreter";  // 1,000,000 requests per day
    public static final String OVERPASS_API_SERVICE_RUSSIAN = "https://maps.mail.ru/osm/tools/overpass/api/interpreter";  // no rate limit
    ...
    public String urlForPOISearch(String tag, BoundingBox bb, int limit, int timeout) {
        ...
        Log.d("BONUSPACK", "urlForPOISearch data=" + data);
        ...
        if(jString == null) {
            ...
            try {
                ...
                while(var8.hasNext()) {
                    ...
                    Log.d("BONUSPACK", "getPOIsFromUrl: " + poi.mUrl);
                    ...
                    Log.d("BONUSPACK", "getPOIsFromUrl: " + poi.mLocation);

                    if(poi.mLocation != null) {
                        pois.add(poi);
                    }
                }
                Log.d("BONUSPACK", "getPOIsFromUrl: " + pois);
        ...
        if(jString == null) {
            ...
            try {
                ...
                while(var8.hasNext()) {
                    ...
                    Log.d("BONUSPACK", "getPOIsFromUrlRoad: " + poi.mLocation);

                    if(poi.mLocation != null) {
                        pois.add(poi);
                    }
                    Log.d("BONUSPACK", "getPOIsFromUrlRoad: " + pois);
                }
